...
class _AzkarState extends State<AzkarElmasa> {
        ...
        home: Container(
            decoration: BoxDecoration(
                image: DecorationImage(
                    image: AssetImage("assets/masa.jpg"), fit: BoxFit.cover)),
            child: Scaffold(appBar: AppBar(
              backgroundColor: Color(0xffF17F42),
              centerTitle: true,
              title: Text("أزكار المساء",style: TextStyle(color: Colors.white,fontSize: 20,fontWeight: FontWeight.bold),)
